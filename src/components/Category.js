  ...
  return (
    <div className={style.leftside}   >
        <ul>
            ...
            <li className={style.list2} style={{ cursor: "pointer" }}>
                <img
            ...
            <li className={style.list3} style={{ cursor: "pointer" }}>
                <img
            ...
            <li className={style.list4} style={{ cursor: "pointer" }}>
                <img
            ...
            <li className={style.list5} style={{ cursor: "pointer" }}>
                <img
            ...
            <li className={style.moreCat}>
                <p>MORE CATEGORIES</p>
            </li>
            <div className={style.moreli} style={{ cursor: "pointer" }}>
            ...
            <li className={style.moreCat} id="hide">
                <p>TRENDING SEARCHES</p>
            </li>
            <div className={style.moreli} id="hide" style={{ cursor: "pointer" }}>
                <li>
                    <span>
                        {" "}
                ...
                <li>
                    <span>
                        {" "}
                        <i class="fas fa-search"></i> Shoes For men
                    </span>
                </li>
                <li>
                    <span>
